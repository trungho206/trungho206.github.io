...
[Tư liệu tự sưu tầm thu nhặt trong quá trình tìm hiểu về thị trường tiền điện tử](https://drive.google.com/drive/folders/1q9Yes95rdEfUPvEQWu_68ZVWnb-xb0-b)
...
* Trên thế giới tại thời điểm này, có tổng cộng hơn 7000 các loại đồng khác nhau nhưng chỉ vài trăm đồng trong số chúng đang được sử dụng chủ yếu trong các hoạt động giao dịch mỗi ngày.  Nổi bật nhất có thể kể đến là đồng Ethereum (ETC) hoạt động dựa trên phương thức hợp đồng thông minh (Smart Contract) nhằm cải thiện tốc độ xử lý giao dịch mà không cần thông qua bên thứ 3, đồng Litecoin (LTC) là một hard fork của Bitcoin sử dụng mạng lưới Lightening Network với việc tăng tính linh hoạt và giảm chi phí giao dịch giữa nhiều người dùng, đồng Cardano (ADA) là một phiên bản cải thiện hoàn chỉnh hơn hẳn so với BTC, LTC, ETH với việc sử dụng mạng lưới Ouroboros và đang hướng đến chiếm vị trí thứ 2 trên bảng xếp hạng tiền điện tử từ tay của ETH. Nhờ có sự cạnh tranh mà thị trường sẽ còn tiếp tục phát triển trong tương lai. Gần đây nhất có thể kể đến là sự phát triển các ứng dụng Defi (phần lớn các ứng dụng đều đang chạy trên mạng lưới blockchain của Ethereum nhưng chắc chắn trong tương lai các mạng lưới như ADA sẽ không để ngơ chiếc bánh này). Thêm một yếu tố nữa là thế giới trong tương lai sẽ hướng tới việc phát triển các ứng dụng decentralized. Điều này được nhắc đến trong cuốn "Life after Google". Khi mà thế giới đang dịch chuyển sang xu hướng mạng lưới decentralized và các open-source platforms khi mà các ông lớn Google, Microsoft, Amazon đang nắm giữ bảo mật thông tin cá nhân của phần đông người dùng trên thế ioiws.
